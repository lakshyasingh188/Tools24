...
function _buildCareerHi(ud, ap, gt) {
    ...
    let extra = '';
    if (isFocus) {
        extra = `\n\nइस विशेष रूप से करियर-केंद्रित विश्लेषण में, हम आपकी कुंडली के व्यावसायिक आयामों में गहराई से जाते हैं। दसवां भाव (कर्म भाव) आपके व्यावसायिक धर्म को समझने के लिए विशेष रूप से महत्वपूर्ण है। ${name}, अपने करियर को दौड़ नहीं बल्कि एक सावधानी से निर्मित मंदिर के रूप में सोचें — हर पत्थर मायने रखता है, और उच्चतम शिखर सबसे मजबूत नींव पर निर्मित होते हैं।`;
    }
    return `### करियर\n\n${name}, आपका व्यावसायिक मार्ग आपकी जन्म पत्रिका में सूर्य, बुध और दसवें भाव के शक्तिशाली संयोजन से प्रकाशित होता है। यह समय आपको ऐसे अवसरों की ओर ले जा रहा है जहाँ आपकी नेतृत्व क्षमता, रणनीतिक दृष्टि और संचार कौशल का समावेश महत्वपूर्ण होगा।\n\n${gt.pronoun} उन भूमिकाओं में सफलता के लिए अनुकूल है जहाँ ${gt.pronoun} पहल कर सकता है, नए विचार प्रस्तुत कर सकता है, और उन्हें कार्यान्वित कर सकता है। आपकी कुंडली में सफलता उन व्यवसायों में अधिक सहज है जो तकनीक, मार्गदर्शन, नेतृत्व, या रचनात्मकता से जुड़ी हों।${extra}`;
}
