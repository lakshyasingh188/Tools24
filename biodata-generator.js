document.addEventListener('DOMContentLoaded', () => {
    ...
    const watermarkGapDiv = document.querySelector('.watermark-gap'); // New element selector
    ...
    generateBtn.addEventListener('click', (e) => {
        ...
        // Hide the input area and watermark gap
        inputAreaDiv.style.display = 'none'; 
        if (watermarkGapDiv) { 
            watermarkGapDiv.style.display = 'none';
        }
        ...
        // Add class to hide watermark using CSS (for cleaner code)
